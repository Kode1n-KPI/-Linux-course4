...
#include <ctype.h>
#include <stdio.h>
#include <string.h> // додаємо для strcmp

#define STRING_MAX 512ull

// Видаляємо зайвий const з типів повернення
...
// Копіювання рядка до певної кількості символів
...
// Перевірка валідності рядка за твоєю логікою
...
// Додаємо forward declaration для quick_sort
